...
import { refaelApi } from '../api';
import { HiUpload, HiDownload, HiDocumentText, HiX, HiCheckCircle } from 'react-icons/hi';
import { createResultDownload, pickFileFromEvent } from '../utils/refaelHandlers';
import './RefaelTools.css';

export default function RefaelToolsPage() {
    ...
    const handleSubmit = async () => {
        ...
        setError(null);
        try {
            const res = await refaelApi.processFiles(file1, file2);
            setResult(res);
        } catch {
    ...
    const handleDownload = () => {
        refaelApi.downloadFile(result?.fileName)
            .then((fileBlob) => {
    ...
    return (
        <div className="page-container">
            <div className="page-header">
                <div>
                    <h1 className="page-title">Refael Tools</h1>
            ...
            <div className="page-content">
                {!result ? (
                    <div className="refael-card glass-card">
                        <div className="refael-uploads">
                        ...
                        {error && (
                            <div className="refael-error">
                                {error}
                            </div>
                        )}

                        <div className="refael-actions">
                    ...
                    <div className="refael-result glass-card animate-scale">
                        <HiCheckCircle size={48} className="refael-result__icon" />
                        <h2>Processing Complete!</h2>
                        <p className="refael-result__desc">Your result file is ready for download</p>
                        <div className="refael-result__file">
                            <HiDocumentText size={24} />
                            <span>{result.fileName}</span>
                        </div>
                        <div className="refael-result__actions">
